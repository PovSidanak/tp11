...
export default {
  ...
  async mounted() {
    ...
    let response_sub_categories = await axios.get("http://localhost:3000/api/v1/subcategory/get_subcategories")
    response_sub_categories.data.forEach((data) => {
        this.sub_categories.push(data)
    })
